...
class TwoLoopsMergePOEnv(Env):
    ...
    * n_merging_in: number of observable merging-in vehicle from the larger
    ...
    def compute_reward(self, rl_actions, **kwargs):
        ...
        normalization = self.scenario.length / self.k.vehicle.num_vehicles
    ...
    def get_state(self, **kwargs):
        ...
        if self.k.vehicle.get_x_by_id(sorted[0]) < merge_len \
                and self.k.vehicleget_x_by_id(sorted[1]) < merge_len:
