...
class TrafficLightGridEnv(Env):
    ...
    * discrete: determines whether the action space is meant to be discrete or
    ...
    def get_state(self):
        ...
        speeds = [
            self.k.vehicle.get_speed(veh_id) / self.scenario.max_speed
    ...
    def _reroute_if_final_edge(self, veh_id):
        ...
        if route_id is not None:
            ...
            type_id = self.k.vehicle.get_state(veh_id, "type")
    ...
    def get_state(self):
        ...
        for node, edges in self.scenario.get_node_mapping():
            for edge in edges:
                ...
                dist_to_intersec += [
                    (self.scenario.edge_length(self.k.vehicle.get_edge(veh_id))
